...
def sell():
    ...
    # 데이터 불러오기, 데이터 형 변환.
    p_path = 'C:\\Users\\innov\\workspace\\realestate_detective1_rawdata\\수도권_연립다세대_매매\\연립다세대_매매_seoul+ggd.csv'
    df = load_data(p_path)
...
def lease():
    ...
    # 데이터 불러오기, 데이터 형 변환.
    p_path = 'C:\\Users\\innov\\workspace\\realestate_detective1_rawdata\\수도권_연립다세대_전월세\\연립다세대_전월세_seoul+ggd.csv'
    df = load_data(p_path)
